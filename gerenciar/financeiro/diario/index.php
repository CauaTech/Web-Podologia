...
if (isset($_GET['excluir'])) {
	...
	header('Location: '.$flow.'financeiro/diario/?notification=excluir');
}

$data = date('d-m-Y');
$sql_vendas = "SELECT * FROM `vortex-financeiro` WHERE `vortex-token`='GwELye0S44ytcoQ93W9ycfGQ8W5u2m2a' && `vortex-data` LIKE '$data%'";
$consulta_vendas = $connect->query($sql_vendas);
$consulta_painel = $connect->query($sql_vendas);
			...
			<div class="col-md-12">
				<div class="responsive-table">
					<table id="fornecedores" class="table table-financeiro">
				        ...
				        <tbody>
				        	<?php while($info_venda = $consulta_painel->fetch_array()){
