...
if (isset($_POST['nome_completo']) && !empty($_POST['nome_completo'])) {
	$kid_completo = $_POST['kid_completo'];
	$kid_nacimento = $_POST['kid_nacimento'];
	...
	$sql_create = "INSERT INTO `vortex-pacientes`(`Nome`, `Nacimento`, `Ocupacao`, `Telefone`, `Telefone_whats`, `Endereco`, `RG`, `CPF`, `paciente_token`,`kid`, `nome_pai`,`nacimento-pai`) VALUES ('$kid_completo','$kid_nacimento','$ocupacao','$telefone','$whats','$endereco','$rg','$cpf ','$token_paciente','1','$nome_completo','$data_nacimento')";
...
<div class="c_pacientes">
	<div class="container">
		...
		<form method="POST">
		<div class="row">
			<h5>Cadastro de Criança</h5>
			<div class="col-md-6">
				<label>Nome Criança</label>
				<input type="text" class="form-control form-control-sm" name="kid_completo">
			</div>
			<div class="col-md-6">
				<label>Data de Nascimento da Criança</label>
				<input type="date" class="form-control form-control-sm" name="kid_nacimento">
			</div>

			<div class="col-md-4">
				<label>Nome Completo Responsavel</label>
			...
			<div class="col-md-4">
				<label>Ocupação Responsavel</label>
			...
			<div class="col-md-4">
				<label>Endereço Responsavel</label>
